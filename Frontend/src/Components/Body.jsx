                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-3 gap-6 mx-4">
                        <div className="bg-gray-100 shadow-md px-5 py-5 rounded-md mt-4">
                            <h2 className="text-center text-2xl font-medium capitalize">Build Once. Share Everywhere</h2>
                            <p className="text-center text-wrap">Create your resume and share a public profile link with ease</p>
                        </div>
                        <div className="bg-gray-100 shadow-md px-5 py-5 rounded-md mt-4">
                            <h2 className="text-center text-2xl font-medium capitalize">Filter by Skills & Projects</h2>
                            <p className="text-center text-wrap">Recruiters can discover you based on your actual skills not just keywords</p>
                        </div>
                        <div className="bg-gray-100 shadow-md px-5 py-5 rounded-md mt-4">
                            <h2 className="text-center text-2xl font-medium capitalize">Fast, Secure , Simple</h2>
                            <p className="text-center text-wrap">Built with modern tech stack (MERN). CareerGrid is lightning fast ans secure</p>
                        </div>
                    </div>
